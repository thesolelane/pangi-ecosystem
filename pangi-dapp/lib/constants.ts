...
export const CATH_TOKEN_MINT_STR = "48rmvKgpGpUNUuH3n2UYTZS2AUxZEkaCiNjQ57q1duMA";
...
let _CATH_TOKEN_MINT: PublicKey | null = null;
...
export const CATH_TOKEN_MINT = () => _CATH_TOKEN_MINT || (_CATH_TOKEN_MINT = new PublicKey(CATH_TOKEN_MINT_STR));
